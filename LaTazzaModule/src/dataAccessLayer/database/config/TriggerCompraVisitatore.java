...
public class TriggerCompraVisitatore implements Trigger {
    ...
    private static final String TRIGGER_PATH = "\"dataAccessLayer.database.config.TriggerCompraVisitatore\"";
    ...
    private boolean existsVisitatore(Object[] newRow) throws SQLException{
        ...
        stat.setString(2, (String) newRow[cognome]);
    ...
    public void fire(Connection connection, Object[] oldRow, Object[] newRow) throws SQLException {
        if(!existsVisitatore(newRow)){
            stat= connection.prepareStatement("insert into "+TABLE_NAME_VISITATORE+" (NOME,COGNOME) values (?, ?)" );
            stat.setString(1, (String) newRow[nome]);
            stat.setString(2, (String) newRow[cognome]);
            stat.executeUpdate();
        }
