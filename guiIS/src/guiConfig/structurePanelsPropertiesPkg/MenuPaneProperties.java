...
public class MenuPaneProperties {
	...
	//labelTitolo
	public static final int DEFAULTX_TITOLO = 95;
	public static final int DEFAULTY_TITOLO = 69;
	public static final int DEFAULT_WIDTH_TITOLO = 110;
	public static final int DEFAULT_HEIGHT_TITOLO = 26;

	//labelTitolo2
	public static final int DEFAULTX_TITOLO2 = 69;
	public static final int DEFAULTY_TITOLO2 = 70;
	public static final int DEFAULT_WIDTH_TITOLO2 = 30;
	...
	public static final Font DEFAULT_FONT_TITOLO = new Font("Avenir", Font.BOLD, 25);
	public static final Font DEFAULT_FONT_TITOLO2 = new Font("Avenir", Font.PLAIN, 22);
