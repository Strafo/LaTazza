...
public class TriggerDebitoModifyPersonale extends ViewDebito implements Trigger {
    ...
    private static final String CREATE_TRIGGER_STATEMENT_INSERT_PERSONALE = "CREATE TRIGGER IF NOT EXISTS " + TRIGGER_NAME_INSERT_PERSONALE + " AFTER INSERT ON "+ TABLE_NAME_PERSONALE +" FOR EACH ROW CALL " + TRIGGER_PATH;
    private static final String CREATE_TRIGGER_STATEMENT_DELETE_PERSONALE = "CREATE TRIGGER IF NOT EXISTS " + TRIGGER_NAME_DELETE_PERSONALE + " AFTER DELETE ON "+ TABLE_NAME_PERSONALE +" FOR EACH ROW CALL " + TRIGGER_PATH;
    private static final String CREATE_TRIGGER_STATEMENT_UPDATE_PERSONALE = "CREATE TRIGGER IF NOT EXISTS " + TRIGGER_NAME_UPDATE_PERSONALE + " AFTER UPDATE ON "+ TABLE_NAME_PERSONALE +" FOR EACH ROW CALL " + TRIGGER_PATH;
