...
public class TriggerMagazzinoModifyCialde extends ViewMagazzino implements Trigger {
    ...
    private static final String CREATE_TRIGGER_STATEMENT_INSERT_CIALDE = "CREATE TRIGGER IF NOT EXISTS " + TRIGGER_NAME_INSERT_CIALDE + " AFTER INSERT ON "+ TABLE_NAME_CIALDE +" FOR EACH ROW CALL " + TRIGGER_PATH;
    private static final String CREATE_TRIGGER_STATEMENT_DELETE_CIALDE = "CREATE TRIGGER IF NOT EXISTS " + TRIGGER_NAME_DELETE_CIALDE + " AFTER DELETE ON "+ TABLE_NAME_CIALDE +" FOR EACH ROW CALL " + TRIGGER_PATH;
    private static final String CREATE_TRIGGER_STATEMENT_UPDATE_CIALDE = "CREATE TRIGGER IF NOT EXISTS " + TRIGGER_NAME_UPDATE_CIALDE + " AFTER UPDATE ON "+ TABLE_NAME_CIALDE +" FOR EACH ROW CALL " + TRIGGER_PATH;
