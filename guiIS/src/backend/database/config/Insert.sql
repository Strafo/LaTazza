...
insert into LATAZZASCHEMA.COMPRA_VISITATORE values ('Andrea','Manzi', 'caff�',10,'2018-07-10 8:00:00' );
insert into LATAZZASCHEMA.COMPRA_VISITATORE values ('Edoardo','Vignola','th�',12,'2019-02-15 17:00:00');


insert into LATAZZASCHEMA.COMPRA_VISITATORE values ('Andrea','Manzi', 'caff�',2000,'2018-07-10 9:00:00');
insert into LATAZZASCHEMA.COMPRA_DIPENDENTE values ('Jacopo','Dapueto', 'caff�',false,2000,'2018-07-10 9:00:00');
