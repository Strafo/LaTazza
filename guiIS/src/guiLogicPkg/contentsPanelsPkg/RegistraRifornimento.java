...
public class RegistraRifornimento extends AbstractPanel {
	...
	public RegistraRifornimento() {
        ...
        creaLabel(labelTipoCialde,DEFAULT_LABELDESCRIPTION[1],DEFAULT_FONT_DESCRIZIONI,DEFAULTX_COLONNA1,
        ...
        creaLabel(labelQuantita,DEFAULT_LABELDESCRIPTION[2],DEFAULT_FONT_DESCRIZIONI,DEFAULTX_COLONNA1,
